			...
			<CarouselPager carousel={eventsCarousel}>
				{(_, i, onClick) => (
					<li
						...
						{...{
							[EVENTS_PAGER_ITEM_SELECTED]:
								eventsCarousel.selected() === i ? "" : undefined,
						}}
					>
						<button onClick={onClick} class={events_pager_button}>
...
export const EventsCarousel: Component = function () {
	return (
		<Carousel carousel={eventsCarousel} class={events_carousel}>
			{(event, meta) => (
				<CarouselItem class={event_class} meta={meta}>
					<div class={event_column}>
						...
						<a class={event_button} href="/events">
							<div>
								<SvgWaveArrowRight />
							</div>
