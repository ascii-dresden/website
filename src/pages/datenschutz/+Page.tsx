	...
	return (
		...
		>
			...
			>
				...
				<p>
					Die folgenden Hinweise geben einen einfachen &Uuml;berblick darüber, was mit
				...
				<p>
					...
					&sect; 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder
				...
				<p>ascii Dresden e.V.</p>
				<p>
					Telefon: +49 351 463 42221
					<br />
					E-Mail: info@ascii-dresden.de
				</p>
				<p>
				...
				<p>
					...
					Datenverarbeitung zusätzlich auf Grundlage von &sect; 25 Abs. 1 TTDSG. Die
				...
				<p>
					...
					Stellen zusammen. Dabei ist teilweise auch eine &Uuml;bermittlung von
