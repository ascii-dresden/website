...
import ascii from "src/components/footer_art.txt?raw";
import { colors, on } from "src/css.ts";

export const Footer: ParentComponent = function Footer() {
	return (
		<>
			...
			>
				...
				>
					Designed with {"<3"} by <A href="https://github.com/emonadeo">Emanuel&nbsp;Pilz</A>
				</p>
			</footer>
		</>
	);
